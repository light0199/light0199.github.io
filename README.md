...
>
### [查看我的博客戳这里 👆](https://light0199.github.io/)
...
```
# Site settings
title: light                   # 你的博客网站标题
SEOTitle: 阿望的博客 | light		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: light0199     # 你的github账号
...
sidebar-avatar: /img/light.jpg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
...
friends: [
    {
        title: "light",
        href: "https://light0199.github.io/"
    },
    {
        title: "Apple",
...
我的博客标题是 **“light”** 但是我想要在搜索的时候显示 **“阿望的博客 | light”** ，这个就需要 SEO Title 来定义了。
